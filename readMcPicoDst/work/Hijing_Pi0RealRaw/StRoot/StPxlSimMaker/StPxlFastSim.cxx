...
#include "StMcPxlRawHitMaker/StPxlRawHit.h"
        ...
        for (UInt_t iLad = 0; iLad < mcPxlSectorHitCol->numberOfLadders(); iLad++)
        {
            ...
            for (UInt_t iSen = 0; iSen < mcPxlLadderHitCol->numberOfSensors(); iSen++)
            {
                ...
                for (UInt_t iHit = 0; iHit < nSenHits; iHit++)
                {
                    ...
                    StPxlRawHit* tempHit = new StPxlRawHit(iSec+1, mcPix->ladder(), mcPix->sensor(), row, column, idTruth);
                    ...
                    pxlRawHitCol.addRawHit((const StPxlRawHit &)tempHit);
                }
            }
        }
    }
