        ...
        for (unsigned short ik = 0; ik < idxPicoTaggedEs.size(); ++ik)
        {
            ...
            for (unsigned short ip = 0; ip < idxPicoPartnerEs.size(); ++ip)
            {
                ...
                if (isGoodPair(epair))
                {
                    ...
                    cout << "1 " << pairMass << " " <<pairDca << " " << pt << " " << eta << " " << dca << " " << nsige << " " << pairPositionX << " " << pairPositionY << " " << pairPositionZ << " " << trk->nHitsFit() << " " << trk->nHitsDedx() << endl;
                }
  ...
  //  else {
        ...
        for (int idx = 0; idx < aElectronPair->GetEntries(); ++idx)
        {
            ...
            if (isGoodPair(epair))
            {
                ...
                cout << "0 " << pairMass << " " << pairDca << " " << pt << " " << eta  << " " << dca << " " << nsige << " " << pairPositionX << " " << pairPositionY << " " << pairPositionZ << trk->nHitsFit() << " " << trk->nHitsDedx() <<  endl;
            }
        }
  //  }
